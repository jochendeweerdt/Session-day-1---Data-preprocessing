...
This repository contains the four hands-on notebooks of Session 1.2. We use them during the session:
the lecturer runs a short demo, then you do a small exercise yourself. Afterwards you can keep using them
as a reference.
